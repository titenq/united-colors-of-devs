...
function renderColors(colorName, colorElement, colorArray, spanColors) {
  ...
  /* let copyToClipboard = document.getElementById(`copyToClipboard${colorName}-${(i + 1) * 10}`);

  document.getElementById(`'copyButton${colorName}${(i + 1) * 10}'`).onclick = function() {
...
for (let i = 0; i < colors.length; i++) {
  renderColors(colors[i].colorName, colors[i].colorElement, colors[i].colorArray, colors[i].spanColors);
}
